 ...
 */
@Entity
@NamedQueries({ @NamedQuery(name = Person.FIND_ALL_NAMEDQUERY, query = "select person from Person person order by person.clientId, person.lastname, person.firstname, person.city, person.street"),
