...
public class AccountAudit
{
   ...
   /**
    * Pretty simple check if the parameters are valid to 'log'. We expect: - 3 parameters - first 2 are String - last is BigDecimal. The parameters are not expected to be null... (all mandatory).
    * 
